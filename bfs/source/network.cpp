...
void Network::bfs(char *outputFile) 
{
  ...
  int num[100]; // hold number of components with each size
  ...
  for (int i = 0; i < numVertices; i++) {
    ...
    if (visited[i] == 0) { // unvisited vertex
      ...
      if (ptr == 2) // only 2 vertices in component
		...
		if (1) {
		  cout << numNonSingle << ": " << ptr << " vertices, " << numberEdges << " edges (";
		  cout << complete << " complete)" << endl;
		}
		
		if (0) 
		  cout << ptr << "  " << complete << endl;
  ...
  cout << endl;
  cout << numSingle << " vertices with degree zero" << endl;
  cout << numTwo << " components with only 2 vertices" << endl;
  cout << numComp3orMore << " components with 3 or more vertices" << endl;
  ...
  cout << "\nSizes of non-singleton components:" << endl;
  cout << "\tmax = " << compSize[size-1];
  cout << ", min = " << compSize[0];
  cout << ", median = " << median;
  cout << ", average = " << avgdata << endl;
  cout << "\t95% confidence interval: " << confUpData << ", " << confLowData << endl;
  ...
  cout << "\nDensities of non-singleton components:" << endl;
  cout << "\tmax = " << compDensity[size-1];
  cout << ", min = " << compDensity[0];
  cout << ", median = " << median;
  cout << ", average = " << avgdata << endl;
  cout << "\t95% confidence interval: " << confUpData << ", " << confLowData << endl;
  cout << endl;
  ...
  if(1) {
	...
	for (int i = 1; i < 100; i++)
	  if (num[i] > 0)
		//cout << num[i] << endl;
		cout << "\t" << num[i] << " components with " << i << " vertices" << endl; 
    //cout << num3 << " " << num4 << " " << num5 << " " << num6 << " " << num7;
  ...
  if(BFS_GML || BFS_WG2) {
    ...
    cout << "\n" << maxSizeComp << " vertices in largest component printed to separate file" << endl;
  }

  fprintf(output, "%d vertices in largest component overall\n",maxCompAll);
  cout << maxCompAll << " vertices in largest component overall" << endl;

  fprintf(output, "%d components are not cliques\n",numNotCliques);
  cout << numNotCliques << " components are not cliques" << endl;
